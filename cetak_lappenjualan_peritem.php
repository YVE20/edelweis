<?php
    ...
    $sqlsel = "select sum(tjd.jumlah) as 'totaljumlah', sum(tjd.total) as 'totalakhir',tj.shift,tm.nama, tm.satuan, tm.harga from tbjualdetil tjd inner join tbmenu tm on tjd.idmenu=tm.id inner join tbjual tj on tjd.idjual=tj.id where tjd.id!='' $syarat group by tjd.idmenu";
