                            ...
                            <div class="col-md-12">
                                <form class="cmxform" id="frm" method="get" action="">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group form-element">
                                                <label style="top:-10px;">Status Hutang</label>
                                                <select class="form-control col-md-7 col-xs-12 combobox" name="cmbstatus" id="cmbstatus">
                                                    <option value="ALL" selected> Semua Hutang </option>
...
<script>
  ...
  function f_search(){
      ...
      $.post("tampilhutang.php",{tombol:"tampilcari",status:status,supplier:supplier,tanggalmulai:tanggalmulai,tanggalselesai:tanggalselesai})
          .done(function(data){
              $("#table").html(data);
          });
  }
